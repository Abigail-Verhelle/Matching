...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //the color of the second player (inactive)
    ...
    private void calculate(){
        //if is equal remove and add points
        if(firstCard == secondCard){
            ...
            iv_21.setImageResource(R.drawable.cover);
            iv_22.setImageResource(R.drawable.cover);
            iv_23.setImageResource(R.drawable.cover);
            iv_24.setImageResource(R.drawable.cover);
            iv_31.setImageResource(R.drawable.cover);
            iv_32.setImageResource(R.drawable.cover);
            iv_33.setImageResource(R.drawable.cover);
            iv_34.setImageResource(R.drawable.cover);
    ...
    private void frontOfCardResources () {
        image101 = R.drawable.byrd;
        image102 = R.drawable.homer;
        image103 = R.drawable.jenny;
        image104 = R.drawable.prather;
        image105 = R.drawable.stjohn;
        image106 = R.drawable.tanner;
        image201 = R.drawable.byrd2;
        image202 = R.drawable.homer2;
        image203 = R.drawable.jenny2;
        image204 = R.drawable.prather2;
        image205 = R.drawable.stjohn2;
        image206 = R.drawable.tanner2;
    }
